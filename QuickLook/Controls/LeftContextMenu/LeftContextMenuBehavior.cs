...
namespace QuickLook.Controls.LeftContextMenu;
...
public sealed class LeftContextMenuBehavior : Behavior<FrameworkElement>
{
    ...
    public static void Register(FrameworkElement frameworkElement, Point? placementOffset = null, PlacementMode placement = PlacementMode.Bottom)
    {
        ...
        if (frameworkElement is Button button)
        {
            button.Click += (_, _) =>
            {
                ShowContextMenu(frameworkElement, placementOffset, placement);
            };
        }
        else
        {
            frameworkElement.MouseLeftButtonDown += (_, _) =>
            {
                ShowContextMenu(frameworkElement, placementOffset, placement);
            };
        }
    ...
    public static void ShowContextMenu(FrameworkElement frameworkElement, Point? placementOffset = null, PlacementMode placement = PlacementMode.Bottom)
    {
